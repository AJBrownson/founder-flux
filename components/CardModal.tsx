...
export default function CardModal() {
  const { selectedCard, selectCard, playCard, players, currentPlayer } =
    useGameStore();
  ...
  const canAffordCard = selectedCard?.cost
    ? (player?.stats.cash || 0) >= selectedCard.cost
    : true;
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedCard.effects.map((effect, index) => {
                      ...
                      const valueText = `${effect.value > 0 ? '+' : ''}${effect.value} ${effect.type}`;
                      const delayText = effect.delay
                        ? ` (in ${effect.delay} turns)`
                        : '';
